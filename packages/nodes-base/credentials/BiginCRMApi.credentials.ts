...
export class BiginCRMApi implements ICredentialType {
	name = 'BiginCRMApi';
	extends = [
		'oAuth2Api',
	];
	displayName = 'Bigin Zoho OAuth2 API';
	...
	properties: INodeProperties[] = [
		...
		},
		{
			...
			name: 'scope',
			type: 'hidden',
			default: 'ZohoBigin.modules.ALL,ZohoBigin.settings.all,ZohoBigin.users.all',
		},
		{
